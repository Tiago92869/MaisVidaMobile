...
const double _kTrackHeight = 36.0; // Reduced from 40.0
const double _kTrackWidth = 72.0; // Reduced from 80.0
const double _kTrackRadius = _kTrackHeight / 2.0;
const double _kThumbRadius = 16.0; // Reduced from 18.0
const double _kSwitchMinSize =
    kMinInteractiveDimension - 10.0; // Reduced slightly
const double _kSwitchWidth = _kTrackWidth - 2 * _kTrackRadius + _kSwitchMinSize;
const double _kSwitchHeight = _kSwitchMinSize + 6.0; // Reduced slightly
